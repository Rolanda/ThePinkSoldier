...
import thepinksoldier.Constante;
...
public class GamePanel extends JPanel implements MouseListener{
    ...
    private final Forme[] clics;
    private final Timer refreshTimer;
    private BasPanel basPanel;
...
public void setBasPanel(BasPanel basPanel){
    ...
    public void choixClic(int x, int y){
        if(clics[0] == null){
            ...
            clics[0] = null;
            clics[1] = null;
            this.basPanel.setScore();
        }
    }
    
    public void graphDestruction(){
        if(Constante.score == -1)
                Constante.score = 0;
